...
const Entry=()=>{
    ...
    axios.get(`https://pokeapi.co/api/v2/pokemon/${pokemon}`)
             .then(async response=>{
                 ...
                 if(abilityDescription.length !== abilities.length){
    ...
    return(
            <div style={{display:'flex', flexDirection:'row', height:'100%', width:'80%'}}>
                <div className='entry'>
                    {desc.length !== 0?
                    ...
                    :
                    <h1 style={{ alignSelf:'center',textAlign:'center', width:'100%'}}>Not Found</h1>
                    }
                </div>
            </div>
            )
